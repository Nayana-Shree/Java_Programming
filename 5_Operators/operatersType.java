public class operatersType {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Money we would remain after buying " + dodgesYouCanBuy + " " + carModel + ": $" + moneyRemaining);
        System.out.println();

        int priceNegative = -14999;
        int priceNegativeWithPlusSign = +priceNegative;
        System.out.println("Negative price with plus sign: $" + priceNegativeWithPlusSign); // -14999
        int priceNegativeWithMinusSign = -priceNegative;
        System.out.println("Negative price with minus sign: $" + priceNegativeWithMinusSign); // 14999
        int priceOneEuroIncrease = ++price;
        System.out.println("Price after 1 euro price increase: $" + priceOneEuroIncrease); // 15999
        int priceOneEuroDecrease = --price;
        System.out.println("Price after 1 euro price decrease: $" + priceOneEuroDecrease); //14999
        System.out.println("This car is damaged: " + !isDamaged); //False
        System.out.println();
        ...
        price += 1000;
        System.out.println("Price increased: $" + price); //15999
        price -= 2000;
        System.out.println("Price decreased: $" + price); //13999
        price *= 2;
        System.out.println("Price multiplied: $" + price); //27998
        price /= 2;
        System.out.println("Price divided: $" + price);//13999
        price %= 10000;
